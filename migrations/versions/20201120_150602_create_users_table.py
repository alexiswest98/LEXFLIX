...
def upgrade():
    ...
    sa.Column('genre1', sa.Integer(), nullable=False),
    sa.Column('genre2', sa.Integer(), nullable=True),
    sa.Column('genre3', sa.Integer(), nullable=True),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    sa.ForeignKeyConstraint(['genre1'], ['genres.id']),
    sa.ForeignKeyConstraint(['genre2'], ['genres.id']),
    sa.ForeignKeyConstraint(['genre3'], ['genres.id']),
    )
