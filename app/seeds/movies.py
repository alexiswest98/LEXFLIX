...
def seed_movies():
    ...
    movie13 = Movie(
        ...
        # genre1= 9,
        # genre2= 3,
        movie_is= "Exciting, Visually Stunning",
        rating= "PG",
        year= 2018,
        duration= "1h 57m", 
    ...
    movie18 = Movie(
        ...
        # genre2= 8,
        # genre3= 6,
        movie_is= "Suspenseful, Emotional",
        rating= "PG-13",
        year= 2009,
        duration= "2h 15m", 
