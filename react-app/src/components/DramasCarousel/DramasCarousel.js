...
export default function DramasCarousel() {
  ...
  const moviesCarousel = movies.filter(mov => mov.genres.includes("Dramas")).slice(0, 6)
  ...
  return (
    <div className="whole-carousel-outer-div">
      <h1 className="movie-carousel-title">Dramas</h1>
      <Swiper
        slidesPerView={6}
        spaceBetween={7}
        slidesPerGroup={6}
