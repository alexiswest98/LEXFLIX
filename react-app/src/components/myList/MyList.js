                        ...
                        >
                            ...
                            <div className="hidden-details-info">
                                <div className="top-half-hidden-details">
                                    ...
                                    <div className="get-details-button-list" onClick={() => setShowModal(true)}>
                                    ...
                                    {showModal && (
                                        <Modal onClose={() => setShowModal(false)}>
                                            <MovieDetail setShowModal={setShowModal} movieId={med.movie_id} />
                                        </Modal>
                                    )}
                                </div>
